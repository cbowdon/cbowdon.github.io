...
create_respondent <- function(
  ...
  # mlx-omni-server caches some prompts, which can skew distributions.
  # To avoid this we inject a meaningless random number at the beginning of each system prompt.
  cache_buster <- sample.int(9999999999, size = 1)
  chat_openai(
    ...
    #model = "gpt-4.1-nano",
    api_key = "n/a",
    system_prompt = interpolate(sprintf(
      "%s\n\n%s",
      cache_buster,
      SYSTEM_PROMPT
    )),
