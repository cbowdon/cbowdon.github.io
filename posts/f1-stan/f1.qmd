...
These are probably reasonable estimates, but it makes sense to put a big variance on the priors to reflect the uncertainty.
...
This hasn't made much difference. McLaren has eased back towards Red Bull because their budget is smaller. Though if we're trying to show constructor performance, you could say they did a lot better than Red Bull relative to their budget. Was budget a bad choice for the prior?
